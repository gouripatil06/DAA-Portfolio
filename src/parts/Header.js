  ...
  return (
    <header className="header">
      <div className="flex justify-between px-4 lg:px-0">
        <a href="/" className="text-theme-blue text-3xl font-bold no-underline">Gouri Patil</a>
      ...
      <ul className="hidden text-theme-blue tracking-widest items-center lg:flex flex-row mt-0">
        ...
        <li className="py-2 lg:py-0">
          <Button
            className={`${path === '/discuss-project' ? 'active-link' : ''} font-medium text-lg px-5 no-underline hover:underline`}
            type="link"
        ...
        <li>
          <Button
            ...
            type="link"
            href="https://github.com/gouripatil06/DAA-Portfolio"
            target="_blank"
